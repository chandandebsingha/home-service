    ...
    <View style={styles.overlay} pointerEvents="auto">
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>
          Your profile has been submitted. You’ll be able to use all features once an admin approves your account.
        </Text>
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#6366f1', borderRadius: 10, paddingVertical: 12, alignItems: 'center' },
