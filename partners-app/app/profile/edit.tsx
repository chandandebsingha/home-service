				...
				<View style={styles.card}>
					...
					{occupations.length === 0 ? (
						<Text style={{ color: "#6b7280", marginBottom: 8 }}>
							No occupations available. You can add later.
						</Text>
					) : (
						<View style={styles.chipsRow}>
							{occupations.map((o) => (
								<TouchableOpacity
									...
									style={[
										styles.chip,
										form.occupationId === o.id && styles.chipActive,
									]}
									onPress={() => updateField("occupationId", o.id)}
								>
									<Text
										style={
											form.occupationId === o.id
					...
					<TextInput
						...
						onChangeText={(t) => updateField("skills", parseList(t))}
					...
					<TextInput
						...
						onChangeText={(t) => updateField("certifications", parseList(t))}
