...
const user_review_controller_1 = require("../controllers/user-review.controller");
...
router.post("/reviews/user", (0, validation_middleware_1.validateRequest)([
    {
        field: "bookingId",
        validator: validation_middleware_1.Validators.isNumber,
...
]), user_review_controller_1.UserReviewController.create);
router.get("/ratings/summary", provider_controller_1.ProviderController.getMyRatingSummary);
router.post("/profile", (0, validation_middleware_1.validateRequest)([
    {
        field: "occupationId",
        validator: validation_middleware_1.Validators.isNumber,
        message: "occupationId must be a number",
        optional: true,
    },
    {
        field: "businessName",
    ...
    },
    {
        ...
        validator: validation_middleware_1.Validators.isString,
        message: "businessAddress must be a string",
        optional: true,
    },
    {
        field: "phoneNumber",
