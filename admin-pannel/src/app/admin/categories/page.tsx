...
export default function CategoriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingCategory) {
        const response = await fetch(getApiUrl(`/services/meta/categories/${editingCategory.id}`), {
          method: 'PUT',
          headers: {
        ...
        const res = await apiPost<Category>('/services/meta/categories', formData, token)
                    ...
                    <TableRow key={category.id}>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          <Button size="sm" variant="destructive" onClick={() => handleDelete(category.id)} disabled={!canManage}>
